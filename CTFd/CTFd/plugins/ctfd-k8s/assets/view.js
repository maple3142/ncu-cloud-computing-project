...
function loadInfo() {
    ...
    var url = "/api/v1/plugins/ctfd-kubernetes/container?challenge_id=" + challenge_id;
    ...
    CTFd.fetch(url, {
        ...
        if (response.remaining_time === undefined) {
            $('#kubernetes-panel').html('<div class="card" style="width: 100%;">' +
                '<div class="card-body">' +
                '<h5 class="card-title">Instance Info</h5>' +
                '<button type="button" class="btn btn-primary card-link" id="kubernetes-button-boot" ' +
            ...
            $('#kubernetes-panel').html(
                `<div class="card" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success card-link" id="kubernetes-button-renew"
            ...
            function showAuto() {
                const c = $('#kubernetes-challenge-count-down')[0];
...
CTFd._internal.challenge.destroy = function () {
    ...
    $('#kubernetes-button-destroy')[0].innerHTML = "Waiting...";
    $('#kubernetes-button-destroy')[0].disabled = true;
    ...
    CTFd.fetch(url, {
        ...
        if (response.success) {
            ...
            $('#kubernetes-button-destroy')[0].innerHTML = "Destroy this instance";
            $('#kubernetes-button-destroy')[0].disabled = false;
            CTFd.ui.ezq.ezAlert({
                title: "Fail",
                body: response.message,
                button: "OK"
...
CTFd._internal.challenge.renew = function () {
    ...
    $('#kubernetes-button-renew')[0].innerHTML = "Waiting...";
    $('#kubernetes-button-renew')[0].disabled = true;
    ...
    CTFd.fetch(url, {
        ...
        if (response.success) {
            ...
            $('#kubernetes-button-renew')[0].innerHTML = "Renew this instance";
            $('#kubernetes-button-renew')[0].disabled = false;
            CTFd.ui.ezq.ezAlert({
                title: "Fail",
                body: response.message,
                button: "OK"
...
CTFd._internal.challenge.boot = function () {
    ...
    $('#kubernetes-button-boot')[0].innerHTML = "Waiting...";
    $('#kubernetes-button-boot')[0].disabled = true;
    ...
    CTFd.fetch(url, {
        ...
        if (response.success) {
            ...
            $('#kubernetes-button-boot')[0].innerHTML = "Launch an instance";
            $('#kubernetes-button-boot')[0].disabled = false;
            CTFd.ui.ezq.ezAlert({
                title: "Fail",
                body: response.message,
                button: "OK"
